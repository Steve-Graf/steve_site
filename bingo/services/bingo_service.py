...
def build_player_layout(tile_pool: list[str], board_size: int) -> list[str]:
    cells = board_size * board_size
    return random.sample(tile_pool, cells)


def empty_completion_state(board_size: int) -> list[bool]:
